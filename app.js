...
const createImg = function (number) {
  const path = `img/Screenshot_${number}.png`;
  return setTimeout(() => {
...
// bt.addEventListener("click", createImg);

// Typescript exercise fernando herrera
